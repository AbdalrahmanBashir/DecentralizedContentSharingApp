 ...
 * This issuer issues merklized credentials centrally.
 */
contract CentralizedCredentialIssuer is IdentityBase, Ownable2StepUpgradeable {
    ...
    /**
     * @dev Revoke claim using its revocationNonce
    ...
    // TODO: Remove from the contract if unused.
    /**
     * @dev Builds claim
